...
def top_vs_vertical_variable_injection():
    ...
    for required_file in ("top.mako", "variable.mako"):
    ...
    render_template_to_file("top.mako", "decks/TOP.DATA", var)
    render_template_to_file("variable.mako", "decks/VARIABLE.DATA", var)
    run_command(f"{flow} decks/TOP.DATA")
    run_command(f"{flow} decks/VARIABLE.DATA")


if __name__ == "__main__":
    top_vs_vertical_variable_injection()
