...
${rhob} ${kd * 86400} ${mu * 86400} ${ko} ${yld} ${f} ${ka * 86400} ${kstr * 1e-3} ${detexp} ${muu * 86400} ${ku} ${rhoc} ${yurca} /
----------------------------------------------------------------------------
SOLUTION
----------------------------------------------------------------------------
EQUIL
...
INJE05 1 1 ${zz - il + 1} ${zz} OPEN 2* /
INJE06 1 ${yy} ${zz - il + 1} ${zz} OPEN 2* /
INJE07 ${xx} 1 ${zz - il + 1} ${zz} OPEN 2* /
PROD01 2 2 1 ${it} OPEN 2* /
PROD02 2 ${yy} 1 ${it} OPEN 2* /
PROD03 ${xx} 2 1 ${it} OPEN 2* /
PROD04 ${xx} ${yy} 1 ${zz} OPEN 2* /
/

% for i in range(len(injestra)):
WCONINJE
INJE01 WATER ${'OPEN' if injestra[i][1] > 0 else 'SHUT'} RATE ${f"{injestra[i][1] * 86400. * 0.1 * float(wc) / il : E}"} 1* 480 /
INJE02 WATER ${'OPEN' if injestra[i][1] > 0 else 'SHUT'} RATE ${f"{injestra[i][1] * 86400. * 0.1 * float(wc) / il : E}"} 1* 480 /
INJE03 WATER ${'OPEN' if injestra[i][1] > 0 else 'SHUT'} RATE ${f"{injestra[i][1] * 86400. * 0.1 * float(wc) / il : E}"} 1* 480 /
INJE04 WATER ${'OPEN' if injestra[i][1] > 0 else 'SHUT'} RATE ${f"{injestra[i][1] * 86400. * 0.1 * float(il - 3 * wc) / il : E}"} 1* 480 /
INJE05 WATER ${'OPEN' if injestra[i][1] > 0 else 'SHUT'} RATE ${f"{injestra[i][1] * 86400. * 1. : E}"} 1* 480 /
INJE06 WATER ${'OPEN' if injestra[i][1] > 0 else 'SHUT'} RATE ${f"{injestra[i][1] * 86400. * 1. : E}"} 1* 480 /
INJE07 WATER ${'OPEN' if injestra[i][1] > 0 else 'SHUT'} RATE ${f"{injestra[i][1] * 86400. * 1. : E}"} 1* 480 /
/
WCONPROD
