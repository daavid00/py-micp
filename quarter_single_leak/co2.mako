...
PROD01 PROD ${xx} ${yy} 1* WAT 0.15 /
PROD02 PROD ${xx - 1} ${yy} 1* WAT 0.15 /
PROD03 PROD ${xx} ${yy - 1} 1* WAT 0.15 /
/

COMPDAT
INJE01 1 1 ${zz - il + 1} ${zz} OPEN /
PROD01 ${xx} ${yy} ${zz - il + 1} ${zz} OPEN /
PROD02 ${xx - 1} ${yy} 1 ${it} OPEN /
PROD03 ${xx} ${yy - 1} 1 ${it} OPEN /
/
