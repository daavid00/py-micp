...
PROD01 PROD 2 1 1* WAT 0.15 /
PROD02 PROD 2 ${yy} 1* WAT 0.15 /
PROD03 PROD ${xx - 1} 1 1* WAT 0.15 /
PROD04 PROD ${xx - 1} ${yy} 1* WAT 0.15 /
PROD05 PROD 1 2 1* WAT 0.15 /
PROD06 PROD 1 ${yy - 1} 1* WAT 0.15 /
PROD07 PROD ${xx} 2 1* WAT 0.15 /
PROD08 PROD ${xx} ${yy - 1} 1* WAT 0.15 /
/

COMPDAT
INJE01 ${ix} ${iy} ${zz - il + 1} ${zz} OPEN 2* /
PROD01 2 1 ${zz - il + 1} ${zz} OPEN 2* /
PROD02 2 ${yy} ${zz - il + 1} ${zz} OPEN 2* /
PROD03 ${xx - 1} 1 ${zz - il + 1} ${zz} OPEN 2* /
PROD04 ${xx - 1} ${yy} ${zz - il + 1} ${zz} OPEN 2* /
PROD05 1 2 1 ${it} OPEN 2* /
PROD06 1 ${yy - 1} 1 ${it} OPEN 2* /
PROD07 ${xx} 2 1 ${it} OPEN 2* /
PROD08 ${xx} ${yy - 1} 1 ${it} OPEN 2* /
/
